...
import styles from "./BankDetailsAccordian.module.css"
...
import lefticon from "assets/Family/lefticon.svg";
import righticon from "assets/Family/righticon.svg";
import bankaccordianicon from "assets/Family/bankaccordianicon.svg";

const BankDetails = ({ expanded, onChange }) => {
  return (
    ...
    <div className={styles.driver_cards_wrapper}>
      <div className={styles.driver_cards}>
        <EmployeeDetailsCard
          ...
          // emp_id="Farmer"
          leftDividerIcon={lefticon}
          rightDividerIcon={righticon}
          profileIcon={bankaccordianicon}
